...
import static org.libdohj.params.AbstractVircleParams.AUXPOW_CHAIN_ID;
...
public class AuxPoWTest {
    static final NetworkParameters params = VircleMainNetParams.get();
    ...
    /**
     * Parse the AuxPoW header from Vircle block #403,931.
     */
    @Test
    public void parseAuxPoWHeader() throws Exception {
        byte[] auxpowAsBytes = ByteStreams.toByteArray(getClass().getResourceAsStream("auxpow_header.bin"));
        ...
        assertEquals(expected, auxpow.getCoinbase().getTxId());
    ...
    /**
     * Test serializing the AuxPoW header from Vircle block #403,931.
     */
    @Test
    ...
    public void checkAuxPoWHeaderNoTxHeader() throws Exception {
        ...
        final NetworkParameters namecoinLikeParams = new VircleTestNet3Params() {
            @Override
        ...
        byte[] auxpowAsBytes = ByteStreams.toByteArray(getClass().getResourceAsStream("auxpow_header_no_tx_header.bin"));
    ...
    public void shouldRejectNonGenerateAuxPoW() throws Exception {
        final byte[] auxpowAsBytes = ByteStreams.toByteArray(getClass().getResourceAsStream("auxpow_header.bin"));
   ...
   /* TODO: JS reimplement with sys header @Test
    public void shouldRejectOwnChainID() throws Exception {
        byte[] payload = ByteStreams.toByteArray(getClass().getResourceAsStream("vircle_block371337.bin"));
