...
import com.vircle.virclej.script.Script;

import java.io.File;
import java.util.List;

/**
 * The following example shows how to use the by virclej provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV virclej app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // 
        // For more information have a look at: https://virclej.github.io/testing and https://bitcoin.org/en/developer-examples#testing-applications
        ...
        // Have a look at the WalletAppKit documentation and its source to understand what's happening behind the scenes: https://github.com/virclej/virclej/blob/master/core/src/main/java/org/virclej/kits/WalletAppKit.java
        ...
        // virclej is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://code.google.com/p/guava-libraries/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();

        // To observe wallet events (like coins received) we implement a EventListener class that extends the AbstractWalletEventListener virclej then calls the different functions from the EventListener class
