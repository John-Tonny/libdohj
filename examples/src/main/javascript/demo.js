...
// To run, grab the virclej bundled JAR and then do something like this:
//
//   jjs -cp virclej-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp virclej-0.12-bundled.jar
//
...
//
//   jjs -cp virclej-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And virclej is a threaded library. This means you
